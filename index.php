...
<form action="index.php" method="get">
  ...
  <?php
    ...
    if (isset($_GET['len'])) {
        ...
        /* viene definita una stringa { $chars } che contiene tutti i caratteri possibili da utilizzare nella password, Includendo lettere minuscole, maiuscole, numeri e simboli speciali. */
